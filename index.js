...
bot.on('guildMemberAdd', member => {
  ...
  channel.send(`Bienvenue sur le serveur Officiel du serveur Kub-Dom je t'invite à utiliser la commande """Markdown? help"""
et à regarder le réglement du serveur merci et bon jeu à toi sur le serveur :video_game:  , ${member}`);
});
